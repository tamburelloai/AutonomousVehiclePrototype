...
def main():
    ...
    parser.add_argument('--model', help='Path of the detection model.',
                        default='/home/pi/Freenove_4WD_Smart_Car_Kit_for_Raspberry_Pi/Code/Server/object_detection/ssd_mobilenet.tflite')
    parser.add_argument('--label', help='Path of the labels file.',
                        default='/home/pi/Freenove_4WD_Smart_Car_Kit_for_Raspberry_Pi/Code/Server/object_detection/coco_labels.txt')
